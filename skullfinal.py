...
def name():
	global c
	a={1:"ᴛʜᴀᴛ's ᴛʜᴇ ᴡᴏʀsᴛ ɴᴀᴍᴇ ɪ ʜᴀᴠᴇ ᴇᴠᴇʀ ʜᴇᴀʀᴅ!👿",2:"ɪ ᴛʜɪɴᴋ ʏᴏᴜʀ ᴀʀᴇ ʀᴏᴍᴀɴᴛɪᴄ ᴘᴇʀsᴏɴ😍",3:"ᴛʜᴀᴛ's ᴀ ʙᴇᴀᴜᴛɪғᴜʟ ɴᴀᴍᴇ😘",4:"ᴛʜᴀᴛ's ᴀ ғᴜɴɴʏ ɴᴀᴍᴇ😂",5:"ᴛʜᴀᴛ's ᴍʏ ғʀɪᴇɴᴅ's ɴᴀᴍᴇ😜",6:"ᴛʜᴀᴛ's ᴀ sᴡᴇᴇᴛ ɴᴀᴍᴇ😋",7:"ʏᴏᴜ ᴡɪʟʟ ᴅɪᴇ sɪɴɢʟᴇ!😭",8:"ɢᴏ! ɢᴇᴛ ᴀ ʙᴇᴛᴛᴇʀ ɴᴀᴍᴇ!🤦"}
	import random
...
print("-"*16)
sleep(1)
a="can you help me in knowing you better"
bae()
print("\n","-"*38)
...
while True:
	...
	if(d=="tell me a joke" or d=="joke" or d=="meme"):
		...
		calcii()
		continue
	elif(d=="play a video" or d=="video" or d=="youtube" or d=="song"):
		sleep(1)
		print("\n","-"*42)
	...
	elif(d=="maps" or d=="map" or d=="naps" or d=="nap" or d=="cap"):
		maps()
		continue
